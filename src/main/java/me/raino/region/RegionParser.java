package me.raino.region;

import java.util.List;

import me.raino.exception.InvalidRegionException;
import me.raino.region.regions.BlockRegion;
import me.raino.region.regions.CircleRegion;
import me.raino.region.regions.ComplementRegion;
import me.raino.region.regions.CuboidRegion;
import me.raino.region.regions.CylinderRegion;
import me.raino.region.regions.IntersectRegion;
import me.raino.region.regions.NegativeRegion;
import me.raino.region.regions.RectangleRegion;
import me.raino.region.regions.SphereRegion;
import me.raino.region.regions.UnionRegion;
...
public class RegionParser {
	...
	public UnionRegion parseUnion(Element ele) throws InvalidRegionException {
		List<Region> regions = parseSubRegions(ele);
		if (regions == null || regions.isEmpty() || regions.size() < 2)
